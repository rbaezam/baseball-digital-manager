defmodule BaseballDigitalManagerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BaseballDigitalManagerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BaseballDigitalManagerWeb.Gettext, "errors", msg, opts)
    end
  end
