...
config :baseball_digital_manager,
  ecto_repos: [BaseballDigitalManager.Repo]
...
config :baseball_digital_manager, BaseballDigitalManagerWeb.Endpoint,
  ...
  live_view: [signing_salt: "J7wbBepi"]
...
config :baseball_digital_manager, BaseballDigitalManager.Mailer, adapter: Swoosh.Adapters.Local
